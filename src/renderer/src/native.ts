...
export const productionApi = {
  ...
  generateChapters: (project: ProjectSnapshot, chapterIds: string[]) =>
    invoke<string>('generate_chapters_audio', { rootPath: project.rootPath, expectedRevision: project.revision, chapterIds }),
